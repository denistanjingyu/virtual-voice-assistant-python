...
IFontDisp = Font
__all__ = [ 'FONTSTRIKETHROUGH', 'Unchecked', 'Default', 'FONTITALIC',
           'OLE_COLOR', 'FONTBOLD', 'Checked', 'OLE_TRISTATE',
           'OLE_XPOS_HIMETRIC', 'OLE_YPOS_CONTAINER', 'IPictureDisp',
           'FONTNAME', 'OLE_YSIZE_PIXELS', 'FontEvents',
           'OLE_YSIZE_CONTAINER', 'OLE_OPTEXCLUSIVE', 'OLE_HANDLE',
           'IFontEventsDisp', 'OLE_ENABLEDEFAULTBOOL', 'Color',
           'Font', 'IPicture', 'LoadPictureConstants',
           'OLE_YPOS_HIMETRIC', 'StdPicture', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_PIXELS', 'Monochrome', 'OLE_XSIZE_HIMETRIC',
           'Gray', 'OLE_XPOS_CONTAINER', 'IFont', 'StdFont',
           'OLE_CANCELBOOL', 'OLE_YSIZE_HIMETRIC', 'IFontDisp',
           'VgaColor', 'FONTSIZE', 'FONTUNDERSCORE',
